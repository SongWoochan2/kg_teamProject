		...
		<div id="contain">
			<form method="post" action="movieModifyForm.do">
				<table class="table table-striped">
					<thead>
						<tr class="success">
							<th colspan="4">영화 정보 조회</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							<th class="warning">영화 제목</th>
							<td colspan="3"><input type="text" class="form-control" maxlength="30"
								value="${movieDTO.movie_name }" disabled></td>
						</tr>
						<tr>
							<td><input type="hidden" name="pg"
								value="${requestScope.pg }"></td>
							<td colspan="3"><input type="hidden" name="movie_code"
								value="${movieDTO.movie_code }"></td>
						</tr>
						<tr>
							<th class="warning">영화 줄거리</th>
							<td colspan="3"><textarea class="form-control" maxlength="1500"
						...
						<tr>
							...
							<td colspan="3"><input type="text" class="form-control" name="make_nation"
								value="${movieDTO.make_nation }" disabled></td>
						</tr>
						<tr>
							<th class="warning">영화감독</th>
							<td colspan="3"><input type="text" class="form-control" name="movie_director"
								value="${movieDTO.movie_director }" disabled></td>
						</tr>
						<tr>
							<th class="warning">영화재생시간</th>
							<td colspan="3"><input type="text" class="form-control" name="movie_recycle_time"
								value="${movieDTO.movie_recycle_time }" disabled></td>
						</tr>
						<tr>
							<th class="warning">영화 상영 등급</th>
							<td colspan="3"><input type="text" class="form-control" name="movie_show_grade_name"
								value="${movieDTO.movie_show_grade_name }" disabled></td>
						</tr>
						<tr>
							<th class="warning">영화 장르</th>
							<td><input type="text" class="form-control" name="movie_type1"
								value="${movieDTO.movie_type1 }" disabled></td>
							<td><input type="text" class="form-control" name="movie_type2"
								value="${movieDTO.movie_type2 }" disabled></td>
							<td><input type="text" class="form-control" name="movie_type3"
								value="${movieDTO.movie_type3 }" disabled></td>
						</tr>
						<tr>
							<th class="warning">영화 개봉일</th>
							<td colspan="3"><input type="text" class="form-control" name="movie_open_date"
