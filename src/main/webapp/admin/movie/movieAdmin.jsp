...
<body>
	...
	<div id="content" align="center">
		<div id="contain">
				...
				<tbody>
					<c:forEach var="movieDTO" items="${requestScope.list }">
						<tr class="warning">
							...
							<td align="left"><a
								href="movieView.do?movie_code=${movieDTO.movie_code }&pg=${moviePage.pg}">${movieDTO.movie_name }</a></td>
							<td>${movieDTO.movie_director }</td>
							<td>${movieDTO.movie_show_grade_name }</td>
			...
			<a href="../movie/movieInsertForm.do?pg=${moviePage.pg }"
