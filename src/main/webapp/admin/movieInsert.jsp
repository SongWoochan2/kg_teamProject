		...
		<tbody>
			<tr>
				<td colspan="3"><input type="text" class="form-control" placeholder="영화 제목"
					maxlength="30" name = "movie_name" required="required" autocomplete="off"></td>
			</tr>
			<tr>
				<td colspan="3"><input type = "hidden" name = "pg" value = "${requestScope.pg }"></td>
			</tr>
			<tr>
				<td colspan="3"><textarea class="form-control" placeholder="영화 줄거리"
						maxlength="1500" style="height : 300px; resize:none;" name = "movie_content" required="required"></textarea></td>
			</tr>
			<tr>
			<td><input type = "text" placeholder="제작국가" name = "make_nation"></td>
			<td><input type = "text" placeholder="영화감독" name = "movie_director"></td>
			<td><input type = "text" placeholder="영화재생시간" name = "movie_recycle_time"></td>
			</tr>
			<tr>
			<td>
			 <select name = "movie_show_grade_name">
			...
			<tr>
			<td colspan="3">
				<textarea class="form-control" placeholder="출연배우진"
						maxlength="1500" style="height : 300px; resize:none;" name = "appear_actor" required="required"></textarea>
			</td>
			</tr>
			<tr><td colspan="3">
