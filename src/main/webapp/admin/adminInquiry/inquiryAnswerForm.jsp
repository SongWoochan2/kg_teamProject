							...
							<table cellspacing="0" cellpadding="0" border="1">
								<tbody>
									...
									<tr>
										...
										<td colspan="3"><input type="text" id="title"name="inquiry_title" value="${inquiry_title }">
										</td>
									</tr>
									<tr>
										...
										<td colspan="3">
											...
											style="height: 94px;" placeholder="※주민번호 등 개인정보가 포함되지 않도록 유의하시기 바랍니다.">${inquiry_content }</textarea>
										</td>
									</tr>
									<tr>
										<th><label for="file">첨부파일</label></th>
										<td colspan="3"><input type="file" id="file"name="inquiry_file" size="51" value="${inquiry_file }">
										</td>
									</tr>
								</tbody>
							</table>
