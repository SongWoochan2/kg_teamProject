...
<div id="full_content_wrap">
	<div class="header_main_div">
		<div id="top_menu_box">
			...
			<div id="top_right_div">
				<p>
					...
					<a href="/MyCGV/clientCenter/clientCenterMain.do?pg=1"><strong>고객센터</strong></a> 
		...
		<div id="header_main">
			<div id="main_inner">
				<div id="inner_left">
					<a href="/MyCGV/main/main/movieMain.do"><img id="header_logo_img" alt="로고이미지" src="/MyCGV/image/logo/moviet_logo.png"></a>
				</div>
				<div id="inner_center">
					<ul class="menu">
