...
(function ($) {
	$(function() {
		$("#content-aside > ul > li:eq(7)").attr("class", "on");	
...
<form id="confirmMemberPwd" name="confirmMemberPwd" method="post" action="confirmPwdDelete.do">
...
<div class="info_box">
		...
		<table>
			...
			<tr>
				<th>비밀번호</th>
				<td><input type="password" id="member_pwd" name="member_pwd"
